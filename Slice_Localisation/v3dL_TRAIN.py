...
if __name__ == '__main__':
    ...
    Arg_parser.add_argument('-i','--STfolds',help='Cross Validation starting fold number.',type = int,default = 1)
    ...
    for fold in range(args.STfolds,args.folds+1):
        ...
        if args.preWeight == True:
            slice_model.load_state_dict(torch.load(args.preWeightName))
            print('model loaded!!!!!........................... ')
        
        #.........Optimizer and Lr Scheduler............
        optimizer = torch.optim.Adam(slice_model.parameters(), lr=learning_rate, foreach=False)
        ...
        for epoch in range(args.epoch):
            ...
            val_loss = 0.0
            slice_model.train()
            for vol, GT_st, GT_end in train_dLoader:
                # use GPU if available
                slice_model.zero_grad()
                ...
                # Training steps
                pred_ST, pred_END = slice_model(vol)
                lossST = loss(pred_ST,GT_st)
                lossEND = loss(pred_END,GT_end)
                lossFn = lossST + lossEND
            ...
            if min_train_loss>train_loss:
                state_dict = slice_model.state_dict()
