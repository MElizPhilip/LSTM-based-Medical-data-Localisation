...
if __name__ == '__main__':
    ...
    Arg_parser.add_argument('-s','--STfold',help='Cross Validation training start fold.',type = int,default = 1)
    ...
    for fold in range(args.STfold,args.folds+1):
        min_train_loss = np.inf # for model check pointing
        csv_META_file = 'folds_csv/brats_f'+str(fold)+'_train.csv'
        last_epoch = 0
        ...
        if args.preWeight == True:
            BraTS_3D_model.load_state_dict(torch.load(args.preWeightName))
            print('model loaded!!!!!........................... ')
        
        #.........Optimizer and Lr Scheduler............
        optimizer = torch.optim.Adam(BraTS_3D_model.parameters(), lr=learning_rate, foreach=False)
        ...
        for epoch in range(args.epoch):
            ...
            for vol, GT_st, GT_end, XGT_st, XGT_end, YGT_st, YGT_end in train_dLoader:
                ...
                # Training steps
                pred_ST, pred_END,Xpred_ST, Xpred_END,Ypred_ST, Ypred_END = BraTS_3D_model(vol)
            ...
            if min_train_loss>train_loss:
                state_dict = BraTS_3D_model.state_dict()
