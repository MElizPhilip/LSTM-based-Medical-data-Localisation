...
class inHouse_3D_LOC(nn.Module):
    def __init__(self, data_sz,kernelSz,lstm_layers=1):
        super(inHouse_3D_LOC, self).__init__()
        self.dSz = data_sz
        ...
        self.XattenST = CBAM(data_sz)
        self.XattenEND = CBAM(data_sz)
        self.YattenST = CBAM(data_sz)
        self.YattenEND = CBAM(data_sz)
