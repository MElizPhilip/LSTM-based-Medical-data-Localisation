...
from Promise_v3dL_data_generator import CustomImageDataset
from Promise_v3dL_network import Promise_3D_LOC
...
if __name__ == '__main__':
    ...
    Arg_parser.add_argument('-d','--data_path',help='Path to data (location of data)',default = '/path/to/the/DATA/Promise12/training')
    ...
    csv_META_file = 'promise12_train_aug.csv'
    last_epoch = 0
    ...
    train_generator = CustomImageDataset(df, args.data_path,train)
    ...
    Promise_3D_model = Promise_3D_LOC(args.kSz)
    
    if torch.cuda.is_available():
        Promise_3D_model.cuda()
    
    if args.preWeight == True:
        Promise_3D_model.load_state_dict(torch.load(args.preWeightName))
        print('model loaded!!!!!........................... ')
    
    #.........Optimizer and Lr Scheduler............
    optimizer = torch.optim.Adam(Promise_3D_model.parameters(), lr=learning_rate, foreach=False)
    ...
    for epoch in range(args.epoch):
        ...
        for vol, GT_st, GT_end, XGT_st, XGT_end, YGT_st, YGT_end in train_dLoader:
            ...
            # Training steps
            pred_ST, pred_END,Xpred_ST, Xpred_END,Ypred_ST, Ypred_END = Promise_3D_model(vol)
        ...
        if min_train_loss>train_loss:
            state_dict = Promise_3D_model.state_dict()
            torch.save(state_dict, ckpt_dir+'.pt')
            last_epoch = epoch
            min_train_loss = train_loss
            print('Model saved..!')
    print('Last epoch saved : ',last_epoch,ckpt_dir+'.pt')